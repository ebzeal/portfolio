...
Treat the structured basic information above as the authoritative source for current facts. If an older conversation message conflicts with it, correct the outdated statement and use the structured fact.
